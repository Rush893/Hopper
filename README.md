...
• Week of Oct 5: open the FS #1 pull request (MCAP logging of truth, estimate and commands in Simulation::step). Then the headless part of #53: replace the hard-coded mode_tune = false switch in main.rs with command-line options --headless --seed N --mcap <path> --weights <file>, and pass a seeded random-number generator into device_sim.rs and wind_sim.rs.
